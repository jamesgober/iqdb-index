# iqdb-index -- Engineering Directives
...
- The trait must be implementable by graph, clustered, and brute-force indexes without awkward abstractions; flat search validates the design.
- Tombstone vs true-deletion semantics are documented per implementation so callers know what `delete()` does.
